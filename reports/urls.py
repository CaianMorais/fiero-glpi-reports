...
urlpatterns = [
    ...
    path("chamados_intervalo/", views.chamados_intervalo, name="chamados_intervalo"),
    ...
    path("chamados_intervalo/export.csv", views.chamados_intervalo_csv, name="chamados_intervalo_csv"),
]